...
enum MapSettingsChangeType { errorThreshold, maxMarkers, displayDays, retentionDays }
...
class StorageSettingsService {
  ...
  static final StreamController<MapSettingsChangeType> _mapSettingsController =
      StreamController<MapSettingsChangeType>.broadcast();

  static Stream<MapSettingsChangeType> get mapSettingsChanges =>
      _mapSettingsController.stream;

  static void _emitMapSettingsChange(MapSettingsChangeType type) {
    if (_mapSettingsController.isClosed) {
      return;
    }
    _mapSettingsController.add(type);
  }
  ...
  static Future<void> setLocationRetentionDays(int days) async {
    ...
    _emitMapSettingsChange(MapSettingsChangeType.retentionDays);
  }
  ...
  static Future<void> setMapDisplayDays(int days) async {
    ...
    _emitMapSettingsChange(MapSettingsChangeType.displayDays);
  }
  ...
  static Future<void> setMaxMapMarkers(int maxMarkers) async {
    ...
    _emitMapSettingsChange(MapSettingsChangeType.maxMarkers);
  }
  ...
  final clamped = meters
    ...
    _emitMapSettingsChange(MapSettingsChangeType.errorThreshold);
  }
