class ConsentResponse {
  ...
  // Additional site-specific consent fields to match all 12 questions
  ...
  /// Check if all required site-specific consents have been given (all 11 required + 1 optional)
  bool hasGivenValidSiteSpecificConsent() {
