...
/// South African-inspired color theme for the Wellbeing Mapper app.
...
class SouthAfricanTheme {
  ...
  static const Color primaryGreen =
      Color(0xFF007749); // Deep green for primary actions
  static const Color primaryBlue =
      Color(0xFF002868); // Deep blue for app bars and accents
  static const Color accentYellow =
      Color(0xFFFFB612); // Bright yellow for highlights
  ...
  static const Color pureWhite =
      Color(0xFFFFFFFF); // Pure white for backgrounds

  // Extended palette for better UI design
  static const Color lightGreen =
      Color(0xFF4CAF50); // Lighter green for success states
  static const Color darkGreen =
      Color(0xFF2E7D32); // Darker green for pressed states
  static const Color lightBlue = Color(0xFF1976D2); // Lighter blue for info
  static const Color darkBlue =
      Color(0xFF0D47A1); // Darker blue for pressed states
  static const Color softYellow =
      Color(0xFFFFF8E1); // Very light yellow for backgrounds
  static const Color softRed =
      Color(0xFFFFEBEE); // Very light red for error backgrounds
  ...
  static const Color privateModeLight =
      Color(0xFFFFF3E0); // Light orange background
  static const Color privateModeDark =
      Color(0xFFE65100); // Dark orange for text

  // Research mode colors (green-based)
  static const Color researchMode = primaryGreen;
  static const Color researchModeLight =
      Color(0xFFE8F5E8); // Light green background
  static const Color researchModeDark =
      Color(0xFF1B5E20); // Dark green for text
  ...
  static ThemeData get materialTheme {
    return ThemeData(
      ...
      textTheme: TextTheme(
        headlineLarge:
            TextStyle(color: neutralBlack, fontWeight: FontWeight.bold),
        headlineMedium:
            TextStyle(color: neutralBlack, fontWeight: FontWeight.w600),
