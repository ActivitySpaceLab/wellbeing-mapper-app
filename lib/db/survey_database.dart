...
class SurveyDatabase {
  ...
  Future<void> _onUpgrade(Database db, int oldVersion, int newVersion) async {
    ...
    if (oldVersion < 8) {
      ...
      await db.execute('''
        ...
        SELECT 
          age, ethnicity, gender, sexuality, birth_place, lives_in_barcelona,
          building_type, household_items, education, climate_activism,
          submitted_at, synced, created_at, 'wellbeing_mapper'
    ...
    if (oldVersion < 9) {
      // Add app-specific consent fields to consent_responses table
  ...
  Future<List<InitialSurveyResponse>> getInitialSurveys() async {
    ...
    return List.generate(maps.length, (i) {
      return InitialSurveyResponse(
        ...
        researchSite: maps[i]['research_site'] as String? ?? 'wellbeing_mapper',
    ...
    try {
      return await db.insert(
        'consent_responses',
        {
          ...
          'synced': 0,
          // New app-specific consent fields
